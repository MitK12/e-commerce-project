...
const Home = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-16 bg-gradient-to-br from-blue-600 via-purple-800 to-pink-500 text-white rounded-2xl">
      {/* Left Section */}
